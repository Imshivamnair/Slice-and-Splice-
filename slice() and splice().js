...
In this example, slice(1, 3) returns a new array 
containing elements from index 1 to 2 (exclusive) of the original array.

*/

/* 2). splice()

The splice() method, on the other hand, is used to change the contents 
of an array by removing or replacing existing elements and/or adding 
new elements. It takes three parameters: the starting index, the number 
of elements to remove, and optional elements to add.
...
i). slice() returns a new array with selected elements from the original 
